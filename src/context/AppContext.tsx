...
const DEFAULT_PATIENTS: Patient[] = [
  ...
  },
  {
    ...
    ipd: 'IPD-6712',
    mobile: '9325215631',
    address: 'Prabhat Road, Lane 5, Erandwane, Pune',
    occupation: 'Bank Officer',
    religion: 'Hinduism',
    bloodGroup: 'B Positive',
    weight: '70 kg',
    height: '168 cm',
    diagnosis: 'Chronic Suppurative Otitis Media (CSOM) with Right Central Tympanic Membrane Perforation',
    comorbidities: 'None',
    allergies: 'None',
    laterality: 'Right',
    procedurePlanned: 'Tympanoplasty (Type 1)',
    consultant: 'Dr. Sophia Vance',
    anaesthetist: 'Dr. Amit Shah (MD Anaesthesia)',
    admissionDate: '2026-07-10',
    surgeryDate: '2026-07-11',
    ward: 'ENT Special Ward',
    room: 'Room 302',
    bed: 'Bed A',
    ...
    investigations: {
      hb: '13.8 g/dL',
      wbc: '6,200 /cu.mm',
      platelets: '2.1 Lakhs/cu.mm',
      creatinine: '0.8 mg/dL',
      ecg: 'Normal Sinus Rhythm',
      cxr: 'Clear lungs'
    },
    remarks: 'Tympanic membrane perforation confirmed on otoscopy. Hearing assessment shows conductive loss.',
    languagePreference: 'Marathi'
  },
  {
    id: 'pat-4',
    name: 'Leela Bai Salunkhe',
    age: 63,
    dob: '1963-08-25',
    gender: 'Female',
    uhid: 'UHID-882910',
    ipd: 'IPD-7109',
    mobile: '9325215632',
    address: 'Shastri Nagar, Yerwada, Pune',
    occupation: 'Homemaker',
    religion: 'Hinduism',
    bloodGroup: 'O Positive',
    weight: '68 kg',
    height: '155 cm',
    diagnosis: 'Severe Bilateral Osteoarthritis of Knee Joint',
    comorbidities: 'Hypertension, Hypothyroidism',
    allergies: 'Sulfa Drugs',
    laterality: 'Left',
    procedurePlanned: 'Total Knee Arthroplasty (Knee Replacement)',
    consultant: 'Dr. Sophia Vance',
    anaesthetist: 'Dr. Amit Shah (MD Anaesthesia)',
    admissionDate: '2026-07-10',
    surgeryDate: '2026-07-11',
    ...
    room: 'Room 105',
    bed: 'Bed B',
    insurance: 'Ayushman Bharat PMJAY Yojana',
    mlc: false,
    emergency: false,
    ...
    investigations: {
      hb: '11.5 g/dL',
      wbc: '7,800 /cu.mm',
      platelets: '2.8 Lakhs/cu.mm',
      creatinine: '1.0 mg/dL',
      ecg: 'Normal Sinus Rhythm',
      cxr: 'Mild cardiomegaly, clear lungs'
    },
    remarks: 'Grade 4 osteoarthritis of left knee confirmed on X-ray. Fit for regional anaesthesia.',
    languagePreference: 'Marathi'
  },
  {
    id: 'pat-5',
    ...
    ipd: 'IPD-8291',
    mobile: '9325215633',
    address: 'Kothrud, Near MIT College, Pune',
    occupation: 'HR Executive',
    religion: 'Hinduism',
    bloodGroup: 'AB Positive',
    weight: '72 kg',
    height: '162 cm',
    diagnosis: 'Term Pregnancy (38 Weeks) with Breech Presentation',
    comorbidities: 'None',
    allergies: 'None',
    laterality: 'Not Applicable',
    procedurePlanned: 'Lower Segment Cesarean Section (LSCS)',
    consultant: 'Dr. Sophia Vance',
    anaesthetist: 'Dr. Amit Shah (MD Anaesthesia)',
    admissionDate: '2026-07-10',
    surgeryDate: '2026-07-11',
    ward: 'Obstetric & Maternity Ward',
    room: 'Room 408',
    bed: 'Bed A',
    insurance: 'Star Health (Family Floater Policy)',
    mlc: false,
    emergency: false,
    asaGrade: 'ASA Grade I',
    vitals: {
    ...
    investigations: {
      hb: '12.0 g/dL',
      wbc: '9,500 /cu.mm',
      platelets: '2.4 Lakhs/cu.mm',
      creatinine: '0.6 mg/dL',
      ecg: 'Normal Sinus Rhythm',
      cxr: 'Not performed (Pregnancy)'
    },
    remarks: 'Fetal heart sound is stable (142 bpm). Breech presentation confirmed on ultrasound. Patient scheduled for elective LSCS.',
    languagePreference: 'English'
  }
];
